...
var Unity_WebRtcNetwork =
{
	...
	{
		//console.log("------- Unity_WebRtcNetwork_Update");
		awrtc.CAPI_WebRtcNetwork_Update(lIndex);
	},

	Unity_WebRtcNetwork_UpdateEx:function(lIndex)
	{
		//console.log("------- Unity_WebRtcNetwork_Update");
		awrtc.CAPI_WebRtcNetwork_UpdateEx(lIndex);
	},
	Unity_WebRtcNetwork_Flush:function(lIndex)
	{
		//console.log("------- Unity_WebRtcNetwork_Flush");
	...
	{
		console.log("------- Unity_WebRtcNetwork_SendData");
	...
	{
		//console.log("------- Unity_WebRtcNetwork_Dequeue");
...
var Unity_MediaNetwork =
{
    ...
    Unity_MediaNetwork_TryGetFrameDataLengthEx: function (lIndex, connectionId) {
        return awrtc.CAPI_MediaNetwork_TryGetFrameDataLengthEx(lIndex, connectionId);
    },
...
var Unity_HtmlTool={
	Unity_Alert:function(e){
		console.log("------- Unity_Alert",e);
		return alert(e);
	},
	Unity_GetWindowProperty:function(e){
		console.log("------- Unity_Alert",e);
		return alert(e);
	},
};
...
mergeInto(LibraryManager.library, Unity_HtmlTool);
mergeInto(LibraryManager.library, Unity_DebugTool);
